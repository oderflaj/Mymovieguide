...
export const Api = {
  ...
  detail: `https://api.themoviedb.org/3/movie/{movie_id}?api_key=9ddd86c03e9f15f4f9f001cedbe9202b&language={language}`,
  video: `https://api.themoviedb.org/3/movie/{movie_id}/videos?api_key=9ddd86c03e9f15f4f9f001cedbe9202b&language={language}`,
};
...
export const GetListMovies = async (sortBy, language, page = 1) => {
  try {
    ...
    url = url.replace("{language}", language).replace("{page}", page);
